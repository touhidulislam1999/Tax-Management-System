...
<head>
    ...
    <title>Tax Collection Database Management System
    </title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand fw-bold" href="index.php">Tax Database <br> Management System</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0"> <!-- Use ms-auto class to push items to the right -->
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="login_page1.php">Login</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="login_page1.php" class="text-reset">Login</a>
                        </p>
                        <p>
                            <a href="index.php" class="text-reset">Career</a>
                        </p>
