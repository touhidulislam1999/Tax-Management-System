...
<head>
    ...
    <title>Users List | Tax Collection DBMS</title>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    if ($count < 30) {
                        ...
                        <tr>
                            ...
                            <td><a button type="submit" class="btn btn-primary btn-block mb-4" style = "background-color: #0E7F28;" href = "update_person.php?user_id=<?php echo $row[1]?>">Edit User Info</button></td>
                            <td><a button type="submit" class="btn btn-primary btn-block mb-4" style = "background-color: #0E7F28;" href = "delete_user.php?user_id=<?php echo $row[1]?>">Delete User</button></a></td>
                        </tr>
                        <?php
                        $count++;
                    }
