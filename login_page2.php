...
<body>
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-md-4">
                <div class="card">
                    <h5 class="card-header text-center fw-bold">Admin Login</h5>
                    <div class="card-body">
                        ...
                        <form action = "signin.php" method = "post">
                            ...
                            <div class="text-center">
                                <p><a href="login_page1.php">User Login</a></p>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Change color of "Remember me" and "Login" links
        var formCheckLabel = document.querySelector(".form-check-label");
        if (formCheckLabel) {
            formCheckLabel.style.color = "#198754";
        }

        var adminLoginLink = document.querySelector(".text-center a[href='login_page1.php']");
        if (adminLoginLink) {
            adminLoginLink.style.color = "#198754";
        }

        // Change color of "Forgot password?" link
